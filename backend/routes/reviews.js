...
function buildPrompt(docType, contextNotes, generalSubType) {
  ...
  const prompts = {
    'Pay Application': `You are a construction project manager reviewing a pay application for Coaster, an MEP consulting firm. Review this pay application carefully.${ctx}
...
[1–2 sentence justification]`,
    ...
    'Invoice': `You are a construction project manager reviewing an invoice for Coaster, an MEP consulting firm.${ctx}
...
[1–2 sentence justification]`,
    ...
    'RFI': `You are a construction project manager reviewing an RFI for Coaster, an MEP consulting firm.${ctx}
...
[Brief reasoning]`,
    ...
    'Submittal': `You are a construction project manager reviewing a submittal for Coaster, an MEP consulting firm.${ctx}
...
[Notes justifying the action and any conditions]`,
    ...
    'Change Order': `You are a construction project manager reviewing a change order for Coaster, an MEP consulting firm.${ctx}
...
[1–2 sentence justification]`,
    ...
    'Construction Drawing': `You are a construction project manager reviewing construction drawings for Coaster, an MEP consulting firm.${ctx}
...
[Flag any ambiguity in who is responsible for what work]`,
    ...
    'General / Other': `You are a construction project manager reviewing a document for Coaster, an MEP consulting firm.${ctx}${generalSubType ? `\n\nDocument type specified by user: ${generalSubType}` : ''}
